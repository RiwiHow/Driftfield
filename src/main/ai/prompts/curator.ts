...
export const curatorPrompt: AgentPromptDescriptor = {
  ...
  instructions: [
    ...
    'For a new document, call delegate_writing with targetDocumentId set to null, then submit the complete draft in one creation proposal. Never substitute a directory ID, title, path, or invented placeholder ID, and never create an empty, placeholder, or partial document for Scribe to fill or replace.',
