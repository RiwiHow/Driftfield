export const AGENT_INVARIANTS = [
  ...
  'Assistant narration from earlier turns is not evidence that a mutation happened. Persistence is established only by a trusted terminal tool result, a trusted application proposal outcome, or a fresh Bash snapshot that directly shows the expected state.',
