...
export const zhCN = {
  assistant: {
    ...
    proposal: { accept: { create: '新建文档', create_lore_category: '新建资料分类', create_volume: '新建卷', delete: '删除文档', delete_lore_category: '删除资料分类', edit: '接受并保存', move_document: '移动文档', story: '更新故事记录', storyBatch: '全部更新故事记录' }, destination: '目标位置', icon: '图标', moveSummary: '从“{{source}}”移动到“{{target}}”', original: '原文', parent: '所属目录', preview: '审阅提案', proposed: '建议稿', reject: '拒绝', rejectAll: '全部拒绝', status: { applying: '正在保存已接受的修改……', conflict: '磁盘文件已变化，提案未应用。', created: '已创建接受的新文档。', createdLoreCategory: '已创建接受的新资料分类。', createdVolume: '已创建接受的新卷。', deleted: '已删除接受的文档。', deletedLoreCategory: '已删除接受的空资料分类。', failed: '无法应用此提案。', missing: '文件已被移动或删除，提案未应用。', moved: '已移动接受的文档。', rejected: '已拒绝提案。', saved: '已保存接受的修改。', stale: '提案生成后项目或草稿已有变化，请让 Agent 重新读取。', storyUpdated: '已更新接受的故事记录。' }, storyBatchTitle: '故事资料同步（{{count}} 项变更）', storyChange: '结构化变更', title: { create: '新建文档“{{title}}”的提案', create_lore_category: '新建资料分类“{{title}}”的提案', create_volume: '新建卷“{{title}}”的提案', delete: '删除文档“{{title}}”的提案', delete_lore_category: '删除资料分类“{{title}}”的提案', edit: '对“{{title}}”的修改提案', move_document: '移动文档“{{title}}”的提案', story: '故事记录“{{title}}”的提案' } },
