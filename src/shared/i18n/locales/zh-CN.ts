...
export const zhCN = {
  assistant: {
    ...
    tools: { hideDetails: '收起详情', input: '调用参数', names: { get_current_document: '读取当前文档', get_document: '读取文档', get_novel_structure: '读取小说结构', propose_document_edit: '提交文档修改提案', propose_document_file_operation: '提交新建或删除文档提案', propose_project_structure_operation: '提交项目结构变更提案' }, output: '调用结果', showDetails: '查看详情', status: { cancelled: '已取消', completed: '已完成', failed: '失败', running: '调用中' } },
