...
export const zhCN = {
  assistant: {
    ...
    tools: { calledBy: '由 {{agent}} 调用', hideDetails: '收起详情', input: '调用参数', names: { delegate_writing: '委派写作给 Scribe', get_current_document: '读取当前文档', get_document: '读取文档', get_novel_structure: '读取小说结构', get_story_state: '读取故事记录', maintain_story_records: '维护故事记录', propose_document_edit: '提交文档修改提案', propose_document_file_operation: '提交新建或删除文档提案', propose_project_structure_operation: '提交项目结构变更提案', propose_story_operation: '提交故事记录变更提案', record_story_question: '记录待澄清事项', resolve_story_question: '解决待澄清事项' }, output: '调用结果', showDetails: '查看详情', status: { cancelled: '已取消', completed: '已完成', failed: '失败', running: '调用中' } },
